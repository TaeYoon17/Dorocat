...
struct Guides:Equatable{
    var onBoardingFinished: Bool = false // 온보딩 첫 화면 가이드
    var goLeftFinished: Bool = false // 타이머 뷰에서 왼쪽으로 스와이프를 알려주는 화면 가이드
    var goRightFinished: Bool = false // 타이머 뷰에서 오른쪽으로 스와이프를 알려주는 화면 가이드
